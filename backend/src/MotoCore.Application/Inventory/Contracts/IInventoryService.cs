...
public interface IInventoryService
{
    ...
    Task<Result<PagedResult<PartDto>>> GetWorkshopPartsPagedAsync(Guid workshopId, Guid requestingUserId, int page, int pageSize, CancellationToken cancellationToken = default);
    ...
    Task<Result<PagedResult<PartMovementDto>>> GetWorkshopMovementsPagedAsync(Guid workshopId, Guid requestingUserId, int page, int pageSize, CancellationToken cancellationToken = default);
}
