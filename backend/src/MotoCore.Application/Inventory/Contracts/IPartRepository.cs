...
public interface IPartRepository
{
    ...
    Task<(IReadOnlyList<Part> Items, int TotalCount)> GetByWorkshopIdPagedAsync(Guid workshopId, int page, int pageSize, CancellationToken cancellationToken = default);
