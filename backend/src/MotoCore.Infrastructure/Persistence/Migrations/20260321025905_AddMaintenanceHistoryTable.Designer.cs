...
namespace MotoCore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260321025905_AddMaintenanceHistoryTable")]
    partial class AddMaintenanceHistoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotoCore.Domain.Inventory.Part", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("WorkshopId", "PartNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("MotoCore.Domain.Inventory.PartMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("part_movements", (string)null);
                });

            modelBuilder.Entity("MotoCore.Domain.MaintenanceHistory.MaintenanceHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
