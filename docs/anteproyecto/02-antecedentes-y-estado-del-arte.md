...
**El parque de motocicletas de Bolivia y su demanda de servicio.** La motocicleta es el vehículo más numeroso del país: según el Cuadro N.º 1.2 del Instituto Nacional de Estadística (INE), elaborado con registros del Registro Único para la Administración Tributaria Municipal (RUAT), en 2024 se contabilizaron **872.550 motocicletas** —el **33,8 %** de todo el parque—, cifra que lo encabeza por delante de vagonetas, automóviles y camionetas, sobre un total de **2.583.283 vehículos**. Su crecimiento no solo es sostenido, sino **más del doble de rápido** que el del parque en conjunto: entre 2021 y 2024 las motocicletas pasaron de **657.718** a **872.550 unidades** (**+32,7 %**), mientras que el parque automotor total creció de 2.226.662 a 2.583.283 vehículos (**+16,0 %**) en el mismo período. Solo en 2024 la variación interanual fue de **+8,9 %** para las motocicletas frente a **+4,6 %** para el conjunto del parque. Por eso su participación no deja de subir: del 29,5 % en 2021 al 33,8 % en 2024. Cada una de esas unidades requiere mantenimiento periódico y reparaciones, lo que sostiene una red amplia de talleres de servicio distribuida por todo el territorio — una base de negocio que crece año a año y que, al hacerlo, empuja a los operadores más exitosos a abrir locales adicionales.
...
| INE — *Encuesta Continua de Empleo* (fuente del indicador de informalidad laboral del 84,2 %). **Cuadro exacto aún no localizado**: la cifra se conoce hoy por difusión secundaria y debe remitirse al cuadro oficial antes de la entrega (PENDIENTES §3.2) | `Falta` — primaria por localizar | https://www.ine.gob.bo/index.php/desocupacion/ |

> **Salvedad sobre el indicador de informalidad.** A diferencia de las cifras del parque automotor, el 84,2 % de informalidad laboral **todavía no se ha remitido a su cuadro oficial**: procede de la Encuesta Continua de Empleo del INE, pero se conoce por difusión secundaria. Se declara como dato por confirmar y no se emplea en ningún cálculo, solo como caracterización cualitativa del sector.

> **Nota de método.** Las cifras de motocicletas del Cuadro N.º 1.2 se presentan desagregadas por tipo de servicio; el total anual empleado aquí es la suma de las tres categorías (particular, público y oficial). Para 2024: 855.268 + 2.278 + 15.004 = **872.550**. Se deja constancia del cálculo para que la cifra sea reproducible a partir de la fuente.
