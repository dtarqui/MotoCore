...
|---|---|---|---|---|---|---|
| Tipo de trabajo | Investigación experimental | Revisión sistemática | Tesis con implementación | Investigación experimental | Revisión de mapeo | **Tesis con validación empírica** |
