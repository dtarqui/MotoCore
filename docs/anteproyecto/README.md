...
Los artefactos que sustentan estos capítulos —requisitos, historias de usuario, modelo de datos, arquitectura, decisiones de diseño y plan de trabajo— están en [../ingenieria/](../ingenieria/) y se referencian desde aquí sin duplicarse. El índice general es [../README.md](../README.md).
