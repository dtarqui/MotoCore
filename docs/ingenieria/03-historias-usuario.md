...
Historias organizadas por épica, con criterios de aceptación en formato **Dado–Cuando–Entonces** y trazabilidad a los requisitos ([Requisitos](02-requisitos.md)) y a la iteración que las construye ([Plan de trabajo](08-plan-trabajo.md) §3).
...
El catálogo completo de actores, incluidos los no humanos, está en [Requisitos](02-requisitos.md) §1. Los roles se nombran en inglés en el sistema; aquí se usa la traducción para la narrativa.
...
Los criterios de aceptación **Dado–Cuando–Entonces** fijan la definición de terminado de cada historia, junto con las condiciones de iteración de [Plan de pruebas](11-plan-pruebas.md) §7.1.
...
La distribución por fases e iteraciones está en [Plan de trabajo](08-plan-trabajo.md) §3.
